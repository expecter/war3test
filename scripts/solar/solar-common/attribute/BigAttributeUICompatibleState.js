...
export default class BigAttributeUICompatibleState {
    static config = {
        ...
        removeAttackIcon: true,
        removeArmorIcon: true
    };
    //
    static goldFrame;
    static lumberFrame;
    ...
    //
    //
    static unitUIContainer;
    static unitArmorContainer;
    static heroUIContainer;
    //
    static hpBackdropFrame;
    static manaBackdropFrame;
    //unit
    static attackValueFrame;
    static armorValueFrame;
    static heroStrValueFrame;
    static heroAgiValueFrame;
    static heroIntValueFrame;
    constructor() {
    ...
    refreshSolarUI() {
        ...
        if (UnitStateUtil.isInvulnerable(unit)) {
            ...
            let baseDef = GetUnitState(unit, UnitStateArmor) - extraDef;
            if (baseDef < 1000000) {
                //整数显示
            ...
            let greenArmorText = TextUtil.toCnUnit(extraDef > 1000000 ? extraDef : Math.round(extraDef));
            if (extraDef > 0) {
    ...
    createUI() {
        ...
        DzFrameSetPoint(BigAttributeUICompatibleState.heroStrValueFrame, FRAMEPOINT_TOPLEFT, NativeFrameUtil.getHeroStrLabel(), FRAMEPOINT_BOTTOMLEFT, 0.005, 0.0);
        //
        ...
        DzFrameSetPoint(BigAttributeUICompatibleState.heroAgiValueFrame, FRAMEPOINT_TOPLEFT, NativeFrameUtil.getHeroAgiLabel(), FRAMEPOINT_BOTTOMLEFT, 0.005, 0.0);
        ...
        DzFrameSetPoint(BigAttributeUICompatibleState.heroIntValueFrame, FRAMEPOINT_TOPLEFT, NativeFrameUtil.getHeroIntLabel(), FRAMEPOINT_BOTTOMLEFT, 0.005, 0.0);
    ...
    static showSolarUI(showAttackAndArmor, showHeroAtts = showAttackAndArmor) {
