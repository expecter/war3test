export default class ArrayUtil {
     ...
     */
    static selectByWhere(dataArray, ...keyAndSelectVal) {
     ...
     * @param key
     */
    static getPropertyVals(array, key) {
        let result = [];
     ...
     */
    static randomElements(array, resultMaxSize) {
        if (array == null || array.length == 0) {
            return null;
        }
     ...
     * @param deleteElement
     */
    static removeElement(array, deleteElement) {
     ...
     * @param callbackfn
     */
    static forEach(array, callbackfn) {
