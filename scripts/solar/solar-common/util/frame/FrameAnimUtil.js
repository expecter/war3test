...
export default class FrameAnimUtil {
     ...
     * Cooldown Frame 对象池
     */
    static cdFramePool = new ObjectPool(() => {
    ...
    static cdRefreshInterval = 0.2;
    /**
     * 返回一个cd对象池 中的 cd Frame
     * @param parent
     * @param cd
     */
    static addCooldown(parent, cd) {
     ...
     *  添加鼠标移入放大动画
     */
    static addEnlargeMouseEnter(frame, widthFactor = 1.05, heightFactor = widthFactor) {
        //点击按钮事件
        frame.addOnClick(() => {
