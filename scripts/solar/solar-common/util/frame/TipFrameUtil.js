...
export default class TipFrameUtil {
     ...
     * @private
     */
    static _sl_tipTextFrameObjectPool = new ObjectPool(() => {
    ...
    static _sl_tipIconTextFrameObjectPool = new ObjectPool(() => {
     ...
     * @param showPlayer
     */
    static showTipText(tipText, framePoint, dur = 1, fontSize = 0.015, showPlayer) {
     ...
     * @param showPlayer
     */
    static showIconTextOnUnit(icon, tipText, unit, dur = 1, iconSize = 0.011, fontSize = iconSize, showPlayer) {
        if (showPlayer != null && GetLocalPlayer() != showPlayer) {
            return;
        }
     ...
     * @param showPlayer
     */
    static showIconMoveIntoAnimation(icon, startX = 0.4, startY = 0.3, toX = 0.08, toY = 0.055, dur = 0.5, showPlayer) {
        if (showPlayer != null && GetLocalPlayer() != showPlayer) {
            return;
        }
        let frames = TipFrameUtil._sl_tipIconTextFrameObjectPool.borrowObject();
