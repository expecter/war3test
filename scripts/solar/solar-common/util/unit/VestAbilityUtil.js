...
export default class VestAbilityUtil {
     ...
     */
    static lightningChain(source, target, damage, targetCountMax = 4, area = 1000, damageAttenuation = 0.1) {
     ...
     * 隐形术
     */
    static invisibility(target, dur) {
     ...
     * @param abilityId
     */
    static addAbilityIfNotHave(unitHandle, dur, abilityId) {
