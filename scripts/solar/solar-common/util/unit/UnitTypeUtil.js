...
export default class UnitTypeUtil {
     ...
     * @param value
     */
    static setUnitTypeName(idOrIdStr, value) {
     ...
     * @param value
     */
    static setHeroTypeProperName(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitIcon(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitTypeTip(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitTypeUbertip(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitTypeModel(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitTypePortraitModel(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
     ...
     * @param value
     */
    static setUnitTypeModelScale(idOrIdStr, value) {
        let uid = LangUtil.getIntId(idOrIdStr);
