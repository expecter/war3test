...
export default class SoundUtil {
     ...
     */
    static playMusic(musicFilePath) {
     ...
     * @param musicFilePath 音乐文件地址
     */
    static playThematicMusic(musicFilePath) {
     ...
     * @param dur
     */
    static playSound(musicFilePath, dur = 1000) {
     ...
     * @param unit
     */
    static playSoundOnUnit(musicFilePath, dur = 1000, unit) {
     ...
     * @param y
     */
    static playSoundOnPos(musicFilePath, dur = 1000, x, y) {
        let sound = SoundUtil.getSoundHandleFromSoundFilePath(musicFilePath, dur);
     ...
     */
    static getSoundHandleFromSoundFilePath(musicFilePath, dur = 1000) {
     ...
     * @param dur 音效持续时间 毫秒单位
     */
    static createSound(musicFilePath, dur = 1000) {
     ...
     * @param dur 音效持续时间 毫秒单位
     */
    static createSound3D(musicFilePath, dur = 1000) {
