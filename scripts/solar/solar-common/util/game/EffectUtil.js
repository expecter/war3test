...
export default class EffectUtil {
     ...
     * 新建特效(创建到坐标)
     */
    static addSpecialEffect(modelName, x, y, size, displayPlayer) {
     ...
     */
    static addSpecialEffectAndDestroy(modelName, x, y, size, lifeTime) {
     ...
     * @param size 大小缩放
     */
    static addSpecialEffectTarget(modelName, targetWidget, attachPointName = TargetAttach.origin, size) {
        if (settings.isEffectDisplay == false) {
     ...
     */
    static addSpecialEffectTargetAndDestroy(modelName, targetWidget, attachPointName = TargetAttach.origin, size, lifeTime) {
     ...
     * @param facingAngle
     */
    static setEffectFacing(effect, facingAngle) {
     ...
     * @param effect
     */
    static destroyEffectNoDeathAnim(effect) {
        if (isDebug) {
     ...
     * @param modlePath
     */
    static setEffectSize(e, size, modlePath) {
