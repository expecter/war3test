...
export default class Buff {
    ...
    _intervalMS = 0;
    durMS = 0;
    ability = null; //获取产生这个Buff的技能。
    attribute;
    /** 叠加层数*/
    _stackCount = 1;
    _sl_last_stackCount = 0; //用于记录层数改变的 改变值
    /** 如圣骑士给友军上了一个增加护甲的buff 则caster为圣骑士 友军为parent */
    parent; //该buff在哪个单位身上
    caster = null; //获取产生这个Buff的单位 施法者 可为空
    /** 创建时间  毫秒单位 1000=1秒 */
    creationTime;
    //太阳刷新临时计时变量
    _SL_interval = 0;
     ...
     */
    constructor(buffType, parent, caster, initBuff) {
     ...
     * 全局任意buff 事件
     */
    static _sl_anyBuffCreatedListeners = [];
    static _sl_anyBuffStackCountChangeListeners = [];
    static _sl_anyBuffDestroyListeners = [];
}
