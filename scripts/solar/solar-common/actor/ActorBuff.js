...
export default class ActorBuff extends Actor {
     ...
     */
    constructor(actorTypeId, unit, creator, initActorBuff) {
        super(actorTypeId);
        ActorBuff.allActorBuffs[this.uuid] = this;
        this.unit = unit;
    ...
    destroy() {
        ...
        deleteKey(ActorBuff.allActorBuffs, this.uuid);
    }
}
