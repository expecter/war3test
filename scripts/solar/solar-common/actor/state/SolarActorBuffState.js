...
export default class SolarActorBuffState {
    ...
    constructor() {
        ...
        BuffUtil.registerBuffType = (buffType) => {
            log.errorWithTraceBack("演员buff系统不能与旧buff系统同时使用！");
            return null;
        };
        BuffUtil.getBuffType = (buffTypeId) => {
            log.errorWithTraceBack("演员buff系统不能与旧buff系统同时使用！");
            return null;
        };
        BuffUtil.forAllBuffTypes = (callback, buffTypeClass) => {
            log.errorWithTraceBack("演员buff系统不能与旧buff系统同时使用！");
            return null;
        };
        BuffUtil.addBuff = (unit, buffTypeId, caster, initBuff) => {
            log.errorWithTraceBack("演员buff系统不能与旧buff系统同时使用！");
            return null;
        };
