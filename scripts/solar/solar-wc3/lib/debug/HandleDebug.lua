...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["6"] = 2,["7"] = 2,["8"] = 4,["9"] = 4,["10"] = 4,["12"] = 4,["13"] = 7,["14"] = 8,["17"] = 11,["18"] = 14,["19"] = 15,["20"] = 16,["21"] = 16,["22"] = 16,["23"] = 16,["24"] = 16,["25"] = 16,["26"] = 16,["27"] = 17,["28"] = 18,["29"] = 20,["31"] = 22,["32"] = 23,["33"] = 28,["34"] = 29,["35"] = 30,["37"] = 33,["38"] = 15,["39"] = 7,["40"] = 5});
local ____exports = {}
...
function HandleDebug.init(self)
    ...
    _G.CreateUnit = function(player, unitid, x, y, face)
        ...
        if not IsHandle(hdl) then
            log.errorWithTraceBack((((((((("创建单位失败！player=" .. tostring(player)) .. " unitType=") .. tostring(unitid)) .. " xy=") .. tostring(x)) .. ",") .. tostring(y)) .. " face=") .. tostring(y))
            return hdl
        end
