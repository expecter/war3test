...
export default class ClosureCounter {
    ...
    static callCount = 0;
    static funNameCallCounts = {};
    static is_init = false;
    static newClosureFlag = {};
    static config = {
        /**报警阀值*/
        alarmThreshold: 3000,
        uniqueAlarm: true,
    ...
    static init() {
        ...
        for (let funName in ClosureCounter.closureFunNames) {
            ...
            _G[funName] = function (...args) {
                let closureIndex = ClosureCounter.closureFunNames[funName];
    ...
    static _sl_countAndcheckAlarmThreshold(handlerFunc, funName) {
        if (handlerFunc == null) {
            return;
        }
