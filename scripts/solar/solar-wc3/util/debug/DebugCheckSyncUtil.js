...
export default class DebugCheckSyncUtil {
    ...
    static start(checkFuns = false) {
        ...
        //收到数据
        SyncUtil.onSyncObjData("CheckSync", (p, obj) => {
    ...
    static initCheckFuns() {
        ...
        DebugVmUtil.sethook(event => {
            ...
            if (!DebugCheckSyncUtil._stopHook && information?.name && SyncFunNames[information.name] == true) {
                ...
                let tsSrcNameLine = DebugVmUtil.getTsSrcLineName(information);
                let tsSrcNameLine3 = DebugVmUtil.getTsSrcLineName(debug.getinfo(3, "nS"));
                let tsSrcNameLine4 = DebugVmUtil.getTsSrcLineName(debug.getinfo(4, "nS"));
    ...
    static check() {
        ...
        for (let index in DebugCheckSyncUtil.checkSyncData) {
            let syncDatas = DebugCheckSyncUtil.checkSyncData[index];
    ...
    static checkSyncDatas(syncDatas) {
        let checkCodeCount = {};
