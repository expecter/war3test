...
local _____602A_7269_81EA_52A8_8FDB_653B = ____exports.default
_____602A_7269_81EA_52A8_8FDB_653B.name = "怪物自动进攻"
function _____602A_7269_81EA_52A8_8FDB_653B.prototype.____constructor(self)
    BaseUtil.onTimer(
        10,
        function(____, count)
...
function _____602A_7269_81EA_52A8_8FDB_653B.Attack(self, line)
    do
        local i = 0
        while i < #line do
