...
export class Frame {
     ...
     * 设置ui模型贴图
     */
    public setFrameModelTexture(path: string) {
     ...
     * 设置ui模型的镜头位置
     */
    public setModelCameraSource(x: number, y: number, z: number) {
     ...
     * 设置ui模型的镜头目标
     */
    public setModelCameraTarget(x: number, y: number, z: number) {
     ...
     * 设置ui模型的动作
     */
    public setModelPlayAnimation(animName: string) {
     ...
     * 新建模型Ui
     */
    public static createMODEL(parent?: number) {
