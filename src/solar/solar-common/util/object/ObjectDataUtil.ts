...
export default class ObjectDataUtil {
     ...
     * @param objIdStr
     */
    static getUnitMissileart(objIdStr: string): string {
     ...
     */
    static getUnitFile(objIdStr: string, format2StandardModelPath = false): string {
     ...
     * @param property
     */
    static getUnitDataNumber<Key extends keyof uobj>(objIdStr: string, property: Key): number {
     ...
     * @param objIdStr
     */
    static getItemName(objIdStr: string): string {
