...
type  BackendLogicUpdateEventCallBackType = (eventPlayer: player, newRandomInt: number, eventKey: string, groupKey: string, timeStamp: number) => void

export default class PlatUtil {

    static allArchiveKeys: string[] = []
     ...
     */
    static getLotteryUsedCount(whichPlayer: player, limitIndex?: number) {
        if (limitIndex == null) {
     ...
     * @param key
     */
    static storeGlobalInt(key: string, val: number) {
     ...
     * @param key
     */
    static getGlobalStoreInt(key: string) {
     ...
     * @param key
     */
    static getGlobalStoreString(key: string) {
    ...
    private static _sl_onBackendLogicUpdateEvent_init = true;

    private static _sl_onBackendLogicUpdateEventCallBacks: {
        [key: string]: SolarTrigger[]
    } = {};
     ...
     * @param callBack
     */
    static onBackendLogicUpdateEvent(key: string, callBack: BackendLogicUpdateEventCallBackType): SolarTrigger {
        if (PlatUtil._sl_onBackendLogicUpdateEvent_init) {
            SyncUtil.onSyncData("DZBLU", (eventPlayer, eventKey) => {
                let callBacks: SolarTrigger[] = PlatUtil._sl_onBackendLogicUpdateEventCallBacks[eventKey];
                if (callBacks) {
        ...
        let solarTriggerSet: SolarTrigger[] = PlatUtil._sl_onBackendLogicUpdateEventCallBacks[key];
