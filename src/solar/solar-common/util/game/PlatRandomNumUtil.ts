...
export default class PlatRandomNumUtil {
    private static limitKey = {};


    static getRandomNumber(whichPlayer: player, key: string): number {
    ...
    static updateRandomNumber(whichPlayer: player, key: string, groupkey: string): boolean {
