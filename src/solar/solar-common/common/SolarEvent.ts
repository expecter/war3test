...
export default class SolarEvent {
     ...
     * @param callback
     */
    onUnitConstructCancel(callback: (e: UnitEvent, solarTrigger: SolarTrigger) => void): SolarTrigger {
     ...
     * @param callback
     */
    onUnitTrainStart(callback: (e: UnitEvent, solarTrigger: SolarTrigger) => void): SolarTrigger {
     ...
     * @param callback
     */
    onUnitTrainFinish(callback: (e: UnitEvent, solarTrigger: SolarTrigger) => void): SolarTrigger {
