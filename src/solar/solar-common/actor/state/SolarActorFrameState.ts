...
export default class SolarActorFrameState {
    ...
    static _sl_mouseFocusItemIndex: number = -1;
    ...
    static showCommandBarButtonActorTooltip(this: void, x: number, y: number) {
    ...
    static showAbilityTooltip(this: void, ability: number) {
