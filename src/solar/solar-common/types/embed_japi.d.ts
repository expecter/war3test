...
/**
 * 设置单位模型 (物品和特效也可以通过这个api更改)
 */
declare function SetUnitModel(dw: unit | item | effect, model: string): void;
...
/**
 ...
 有些模型有些情况下使用此函数会底层jass报错（有些环境又不会）
 */
 ...
 * 设置单位技能隐藏
 */
declare function SetUnitAbilityButtonShow(unit: unit, abilityID: number, isShow: boolean): void;
 ...
 * 清除缓存
 * */
declare function ReleaseString(str: string): void;

declare function ReleaseAllString(): void;

declare function GetCacheStringCount(): number;

declare function DumpAllString(filename: string): number;

declare function ReleaseModel(model_path: string): void;

declare function ReleaseAllModel(): void;

declare function GetCacheModelCount(): number;
 ...
 * @constructor
 */
declare function ReleaseMemory(): void;

/**
 * 重新实现的 japi 可以对单位独立修改，需要单位先添加技能 再修改 删除技能后即清除数据
 */
// 设置单位技能范围
// @param unit u 单位
...
declare function SetUnitAbilityRange(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityArea(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityCool(u: unit, abil: number, cool: number, max_cool: number): boolean;
...
declare function SetUnitAbilityDataA(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityDataB(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityDataC(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityDataD(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityDataE(u: unit, abil: number, data: number): boolean;
...
declare function SetUnitAbilityButtonPos(u: unit, abil: number, x: number, y: number): boolean;
...
declare function SetUnitAbilityHotkey(u: unit, abil: number, hotkey: string): boolean;
...
declare function SetUnitAbilityTargs(u: unit, abil: number, targs: number): boolean;
...
declare function SetUnitAbilityCost(u: unit, abil: number, cost: number): boolean;
...
declare function SetUnitAbilityUnitId(u: unit, abil: number, unit_id: number): boolean;
...
declare function SetUnitAbilityReqLevel(u: unit, abil: number, req_level: number): boolean;

// 单位是否拥有技能, 填父模板id 拥有子模版id 也会返回true
// @param unit u 单位
// @param integer abil 技能ID
// @return boolean 单位是否拥有技能
declare function UnitHasAbility(u: unit, abil: number): boolean;
...
declare function SetUnitAbilitySpellBookDataA(u: unit, abil: number, abil_list: string): boolean;

// 创建命令按钮
// @return integer 创建的命令按钮  可以用UI的锚点位置 修改大小
declare function CreateCommandButton(): number;

// 销毁命令按钮
// @param integer btn 命令按钮ID
declare function DestroyCommandButton(btn: number): void;

// 命令按钮点击事件
// @param integer btn 命令按钮ID
// @param integer mouse_type 鼠标类型
declare function CommandButtonClick(btn: number, mouse_type: number): void;

// 设置命令单位技能
// @param integer btn 命令按钮ID
// @param unit u 单位
// @param integer abil 技能ID
declare function SetCommandUnitAbility(btn: number, u: unit, abil: number): void;


//获取玩家当前选中的物品, 返回值是同步的,需要提供玩家参数
declare function GetSelectItem(Player: player): item;


//获取物品模型缩放比例
declare function EXGetItemSize(Handle: item): number;


//物品模型 x轴旋转  乘法计算
declare function EXItemMatRotateX(Handle: item, rotate_x: number): void;

//物品模型 y轴旋转  乘法计算
declare function EXItemMatRotateY(Handle: item, rotate_y: number): void;

//物品模型 z轴旋转  乘法计算
declare function EXItemMatRotateZ(Handle: item, rotate_z: number): void;

//物品模型恢复
declare function EXItemMatReset(Handle: item): void;
