...
declare interface AppUnitData {
    ...
    /**太阳演员技能 列表 (通常用于存放 单例原生模版 如单位升级 */
    _SL_solarActorAbilitys?: { [abilityId: string]: any }//ActorAbility
    /** 单位所属的 太阳actorUnit*/
...
declare interface AppAbilityTypeData {
    ...
    /**
     * @deprecated see 推荐1个技能类型对应一个演员技能 但技术层面不应该限制为这样(因为这样会导致自定义地图没法完全自定义 比如模拟建造时就要更多的魔改权限)
     */
...
declare interface BaseAttribute {
    ...
    _SL_BA_armor?: number
    /**基础最大生命值 模拟后可破340涧*/
    _SL_BA_max_life?: number
    /**基础最大魔法值 模拟后可破340涧*/
    _SL_BA_max_mana?: number
    //英雄
    /**基础力量 白字力量*/
    _SL_BA_str?: number
    /**基础敏捷 白字敏捷*/
...
declare interface SolarAttribute extends BaseAttribute {
    ...
    /**主属性 */
    primary_property?: number,
    /**主属性百分比 */
    primary_property_p?: number,
    /**力量*/
    strength?: number,
    /**力量百分比*/
    strength_p?: number,
...
declare interface SolarBuffType {
    ...
    class?: "基础" | "羁绊" | "商城" | "神器" | "境界" | "入体装备" | "法宝" | "丹药" | "奇遇" | "套装" | "奖励" | "AI" | string,
