...
export default class 单位自动创建系统 {
    ...
    //给敌人创建名字漂浮
    static isCreateEnemyNameTextTagOnLoc: boolean = true;
    //靠近创建范围
    ...
    static setOnDestroy(actorUnit: ActorItem, reviveTime: number, player: player, itemId: string, x: number, y: number) {
    ...
    static createTextTag(loc: Vector, text: string) {
